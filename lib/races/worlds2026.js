...
export const WORLDS_2026_MEN = {
  ...
  startlistSources: [
    ...
    { label: "Individual time trial — ProCyclingStats", href: "https://www.procyclingstats.com/race/world-championship-itt/2026/startlist" },
  ],
  ...
  stages: [
    {
      ...
      eligibleRiderIds: [
        "evenepoel", "ganna", "soderqvist", "geewest", "mleonard",
        "amayer", "bmunton", "kwiatkowski", "mullen",
        "seixas", "armirail", "tratnik"
      ],
      eventName: {
    ...
    },
    {
      ...
      eligibleRiderIds: [
        "ayuso", "gbennett", "bettiol", "carapaz", "pacote", "eulalio",
        "evenepoel", "fisherblack", "tfoss", "geewest", "healy", "honore",
        "houle", "thjohannessen", "kench", "kwiatkowski", "leknessund",
        "mleonard", "hlopez", "amayer", "meehan", "mullen", "bmunton",
        "narvaez", "nordhagen", "boliver", "pithie", "rafferty", "seixas",
        "simmons", "skaarseth", "soderqvist", "cstrong", "svestadbardseng",
        "vanaert", "vanderpoel", "mwoods", "zukowsky",
        "roglic", "tratnik", "mohoric", "mezgec", "govekar", "glivar",
        "finkst", "omrzel",
        "armirail", "sivakov", "labrosse", "vparetpeintre", "lbarre",
        "prodhomme", "baudin"
      ],
      eventName: {
...
export const WORLDS_2026_WOMEN = {
  ...
  startlistSources: [
    { label: "Road race — federation selections", href: "https://www.uci.org/competition-details/2026/ROA/77169" },
    { label: "World Championships — UCI", href: "https://www.uci.org/competition-hub/2026-uci-road-world-championships/14QBdFX8GqbCHUPE234D0Q" },
  ],
