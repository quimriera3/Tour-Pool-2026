...
// of the same circuit.
//
// NOTE: there is no published elite women's startlist yet. National quotas are
// known (Netherlands, Italy, Switzerland, France and Poland have seven riders
// each; Spain, Great Britain, New Zealand, Norway, Canada, Belgium, Germany,
// USA and Australia six), but federations have not named their selections.
// `riders` therefore stays empty rather than being filled with guesses — the
// picker shows its "startlist not published" panel until the names are real.
export const WORLDS_2026_WOMEN = {
  ...
  // Nations with confirmed quota places. Rider names follow once federations
  // announce their selections.
  teams: [
    "Netherlands", "Italy", "Switzerland", "France", "Poland",
    "Spain", "Great Britain", "New Zealand", "Norway", "Canada",
    "Belgium", "Germany", "United States", "Australia",
  ],
  officialTeams: [],
  riders: [],
};
