...
//
// Distances, elevation gain and profile scores are real, taken from
// ProCyclingStats. Total: 3,298.5 km and 56,000 m of climbing.
//
// ⚠️ ONE FIELD STILL NEEDS REAL DATA BEFORE THIS RACE GOES LIVE:
...
//     with the official ones once the organisers publish the roadbook.
...
export const VUELTA_2026 = {
  ...
  // Short, uppercase wordmark shown in the site's logo.
  brandName: {
    en: "LA VUELTA", es: "LA VUELTA", ca: "LA VUELTA",
    fr: "LA VUELTA", it: "LA VUELTA", nl: "LA VUELTA",
  },
  shortName: {
    en: "La Vuelta 2026",
    es: "La Vuelta 2026",
  ...
  stages: [
    {
      ...
      from: "Monaco", to: "Monaco", km: 9.4, type: "itt", elevationGain: 224, profileScore: 19,
      preview: "La Vuelta opens where no Spanish Grand Tour has started before: the streets of Monaco. At just 9.4 km, this individual time trial is short but technical, winding past the Casino and through the tight corners of the principality. Expect small gaps — but in a race this hard, even ten seconds gained on day one can matter three weeks later.",
      previewEs: "La Vuelta arranca donde ninguna gran vuelta española lo había hecho antes: las calles de Mónaco. Con solo 9,4 km, esta contrarreloj individual es corta pero técnica, pasando junto al Casino y encadenando las curvas cerradas del principado. Las diferencias serán pequeñas, pero en una carrera tan dura, diez segundos ganados el primer día pueden pesar tres semanas después.",
    },
    {
      n: 2, date: "2026-08-23", startTime: "13:00",
      from: "Monaco", to: "Manosque", km: 204, type: "hills", elevationGain: 3110, profileScore: 83,
      preview: "A long second day takes the peloton out of Monaco and north into Provence. At 204 km and with over 3,000 m of climbing it is a genuine test of endurance so early in the race, and there is enough rolling terrain to tempt a breakaway. Whether it stays together depends entirely on how badly the sprinters' teams want it.",
      previewEs: "Una segunda jornada larga saca al pelotón de Mónaco rumbo al norte, hacia la Provenza. Con 204 km y más de 3.000 m de desnivel es una prueba real de resistencia tan pronto, y hay suficiente terreno ondulado como para tentar a una escapada. Que llegue agrupada dependerá por completo de cuánto la quieran los equipos de los esprínters.",
    },
    {
      n: 3, date: "2026-08-24", startTime: "13:15",
      from: "Gruissan", to: "Font Romeu", km: 174, type: "hills", elevationGain: 2596, profileScore: 173,
    ...
    },
    {
      ...
      from: "Andorra la Vella", to: "Andorra la Vella", km: 104.8, type: "mountains", elevationGain: 3009, profileScore: 239,
      preview: "Barely 105 km, but with 3,000 m of climbing packed into them it is almost certainly the hardest day of the opening week. Andorra packs relentless climbing into a short distance, and short mountain stages have a habit of exploding early. There is nowhere to hide here: the general classification contenders will be fully exposed before the first rest day.",
      previewEs: "Apenas 105 km, pero con 3.000 m de desnivel concentrados en ellos es casi con toda seguridad el día más duro de la primera semana. Andorra concentra subidas implacables en poca distancia, y las etapas de montaña cortas tienen la costumbre de explotar pronto. Aquí no hay dónde esconderse: los aspirantes a la general quedarán retratados antes del primer día de descanso.",
    },
    {
      n: 5, date: "2026-08-26", startTime: "13:15",
      from: "Falset", to: "Roquetes", km: 173.3, type: "hills", elevationGain: 1659, profileScore: 82,
    ...
    },
    {
      ...
      from: "Alcossebre", to: "Castellón", km: 177.4, type: "hills", elevationGain: 3045, profileScore: 171,
    ...
    },
    {
      ...
      from: "Vall d'Alba", to: "Aramón Valdelinares", km: 149.8, type: "mountains", elevationGain: 3572, profileScore: 248,
    ...
    },
    {
      ...
      from: "Puçol", to: "Xeraco", km: 171, type: "flat", elevationGain: 1305, profileScore: 37,
    ...
    },
    {
      ...
      from: "Villajoyosa", to: "Alto de Aitana", km: 187.4, type: "mountains", elevationGain: 5048, profileScore: 321,
    ...
    },
    {
      ...
      from: "Alcaraz", to: "Elche de la Sierra", km: 184.7, type: "hills", elevationGain: 2670, profileScore: 100,
    ...
    },
    {
      ...
      from: "Cartagena", to: "Lorca", km: 151.3, type: "flat", elevationGain: 1391, profileScore: 42,
    ...
    },
    {
      ...
      from: "Vera", to: "Calar Alto", km: 166.6, type: "mountains", elevationGain: 4460, profileScore: 318,
    ...
    },
    {
      ...
      from: "Almuñécar", to: "Loja", km: 192.8, type: "hills", elevationGain: 3399, profileScore: 115,
    ...
    },
    {
      ...
      from: "Jaén", to: "Sierra de la Pandera", km: 154.5, type: "mountains", elevationGain: 4060, profileScore: 335,
    ...
    },
    {
      ...
      from: "Palma del Río", to: "Córdoba", km: 189.7, type: "hills", elevationGain: 2853, profileScore: 105,
    ...
    },
    {
      ...
      from: "Cortegana", to: "Palos de la Frontera", km: 181.1, type: "flat", elevationGain: 2244, profileScore: 47,
    ...
    },
    {
      ...
      from: "Dos Hermanas", to: "Seville", km: 185, type: "flat", elevationGain: 956, profileScore: 5,
    ...
    },
    {
      ...
      from: "El Puerto de Santa María", to: "Jerez de la Frontera", km: 32.1, type: "itt", elevationGain: 178, profileScore: 2,
      preview: "The decisive time trial: 32.1 km of largely flat terrain through the sherry country of Cádiz. This is the longest Vuelta time trial in years and the single biggest opportunity for a powerful rouleur to overturn the general classification before the final mountains.",
      previewEs: "La contrarreloj decisiva: 32,1 km de terreno mayoritariamente llano por la tierra del jerez, en Cádiz. Es la crono más larga de La Vuelta en años y la mayor oportunidad para que un rodador potente le dé la vuelta a la general antes de la última montaña.",
    },
    {
      n: 19, date: "2026-09-11", startTime: "13:00",
      from: "Vélez-Málaga", to: "Peñas Blancas", km: 210.8, type: "hills", elevationGain: 3987, profileScore: 271,
      preview: "The longest stage of the whole Vuelta at 210.8 km, running along the Costa del Sol and finishing with the climb to Peñas Blancas above Estepona — a steady 19 km ascent. Officially classified as hilly, but with nearly 4,000 m of climbing and a summit finish, this will race like a mountain stage.",
      previewEs: "La etapa más larga de toda La Vuelta, con 210,8 km por la Costa del Sol y final en la subida a Peñas Blancas, por encima de Estepona: 19 km de ascensión constante. Clasificada oficialmente como ondulada, pero con casi 4.000 m de desnivel y final en alto, se correrá como una etapa de montaña.",
    },
    {
      n: 20, date: "2026-09-12", startTime: "13:00",
      from: "La Calahorra", to: "Collado del Alguacil", km: 186.8, type: "mountains", elevationGain: 5041, profileScore: 526,
    ...
    },
    {
      ...
      from: "Granada", to: "Granada", km: 112, type: "flat", elevationGain: 1193, profileScore: 86,
      preview: "No processional finish this year. La Vuelta ends with 112 km of racing on a Granada circuit featuring a climb of roughly one kilometre up to the Alhambra. It is a genuinely competitive final stage in one of the most spectacular settings any Grand Tour has ever used.",
      previewEs: "Este año no hay paseo final. La Vuelta termina con 112 km en un circuito por Granada que incluye una subida de aproximadamente un kilómetro hasta la Alhambra. Es una etapa final realmente competitiva en uno de los escenarios más espectaculares que jamás haya usado una gran vuelta.",
    },
  ],
