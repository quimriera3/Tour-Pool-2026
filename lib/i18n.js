...
export function useLang() {
  ...
  const match = pathname.match(/^\/(es|ca|fr|it|nl)(?=\/|$)/);
...
const TRANSLATIONS = {
  // ---------- Nav ----------
  "nav.home": { en: "Home", es: "Inicio", ca: "Inici", fr: "Accueil", it: "Home", nl: "Home" },
  "nav.riders": { en: "Riders", es: "Corredores", ca: "Ciclistes", fr: "Coureurs", it: "Corridori", nl: "Renners" },
  "nav.leaderboard": { en: "Leaderboard", es: "Clasificación", ca: "Classificació", fr: "Classement", it: "Classifica", nl: "Klassement" },
  "brand.race": { en: "GRAND TOUR", es: "GRAND TOUR", ca: "GRAND TOUR", fr: "GRAND TOUR", it: "GRAND TOUR", nl: "GRAND TOUR" },
  "nav.stages": { en: "Play", es: "Jugar", ca: "Jugar", fr: "Jouer", it: "Gioca", nl: "Speel" },
  "nav.jerseys": { en: "Jerseys", es: "Maillots", ca: "Mallots", fr: "Maillots", it: "Maglie", nl: "Truien" },
  "nav.rules": { en: "Rules", es: "Reglas", ca: "Regles", fr: "Règles", it: "Regole", nl: "Regels" },
  "nav.faq": { en: "FAQ", es: "FAQ", ca: "FAQ", fr: "FAQ", it: "FAQ", nl: "FAQ" },
  "nav.signup": { en: "Sign up / Log in", es: "Regístrate / Inicia sesión", ca: "Registra’t / Inicia sessió", fr: "S’inscrire / Se connecter", it: "Registrati / Accedi", nl: "Registreren / Inloggen" },
  "nav.logout": { en: "Log out", es: "Cerrar sesión", ca: "Tancar sessió", fr: "Se déconnecter", it: "Esci", nl: "Uitloggen" },
  ...
  "predictions.seeDetails": { en: "See event details", es: "Ver detalles de la prueba" },
