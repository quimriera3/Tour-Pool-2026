...
const TRANSLATIONS = {
  ...
  "brand.race": { en: "LA VUELTA", es: "LA VUELTA", ca: "LA VUELTA", fr: "LA VUELTA", it: "LA VUELTA", nl: "LA VUELTA" },
  "nav.stages": { en: "Stages", es: "Etapas" },
  ...
  "jersey.subtitle": {
    en: "Predict who takes home each jersey at the end of La Vuelta. Tap a jersey to make your pick. These predictions lock before Stage 5.",
    es: "Predice quién se llevará cada maillot al final de La Vuelta. Toca un maillot para hacer tu predicción. Estas predicciones se bloquean antes de la Etapa 5.",
  },
  ...
  // ---------- Riders page ----------
  "riders.eyebrow": { en: "Start list", es: "Lista de corredores" },
  "riders.title": { en: "Riders", es: "Corredores" },
  "riders.subtitle": {
    en: "Tap a team to see its riders, or search a name directly. Teams marked \u2713 Official lineup have their full Vuelta 2026 squad confirmed — everyone else's roster is still being filled in as teams announce their riders.",
    es: "Toca un equipo para ver sus corredores, o busca un nombre directamente. Los equipos marcados con \u2713 Alineación oficial ya tienen su equipo completo confirmado para La Vuelta 2026 — el resto se irá completando a medida que los equipos anuncien a sus corredores.",
  },
  ...
  "rules.jersey.body": {
    en: "Besides the stages, you can predict who wins the Red, Green, Polka Dot, and White jerseys. These predictions lock 1 hour before Stage 5 starts. Each jersey you predict correctly adds 10 points to your leaderboard total — up to 40 points if you get all four right, on top of whatever you score from your 21 stage picks.",
    es: "Además de las etapas, puedes predecir quién gana los maillots Rojo, Verde, de Lunares y Blanco. Estas predicciones se bloquean 1 hora antes de la salida de la Etapa 5. Cada maillot que aciertes suma 10 puntos a tu clasificación — hasta 40 puntos si aciertas los cuatro, además de lo que sumes con tus 21 predicciones de etapa.",
  },
  "rules.prizes.title": { en: "Prizes", es: "Premios" },
  "rules.prizes.body": {
    en: "There will be 3 prizes at the end of La Vuelta, all cycling gear (exact items to be confirmed). Standings are based on total points from the stage predictions.",
    es: "Habrá 3 premios al final de La Vuelta, todos material ciclista (los artículos exactos están por confirmar). La clasificación se basa en los puntos totales de las predicciones de etapa.",
  },
  ...
  // ---------- Disclaimer banner ----------
  "disclaimer.text": {
    en: "Rider squads aren't official yet. La Vuelta 2026 has 23 teams, but full 8-rider rosters are usually only confirmed 1-2 weeks before the start. The riders you see here are a partial, growing list — more will be added as teams confirm them.",
    es: "Las plantillas todavía no son oficiales. La Vuelta 2026 tiene 23 equipos, pero las plantillas completas de 8 corredores normalmente solo se confirman 1-2 semanas antes de la salida. Los corredores que ves aquí son una lista parcial y creciente — se irán añadiendo más a medida que los equipos los confirmen.",
  },
  ...
  "home.eyebrow": { en: "La Vuelta a España 2026 · 22 Aug — 13 Sept", es: "La Vuelta a España 2026 · 22 ago — 13 sept" },
  "home.title": { en: "La Vuelta Pool 2026", es: "Porra de La Vuelta 2026" },
  "home.subtitle": {
    en: "Pick a winner for every stage, beat your friends, and win cycling gear. 3,298 km · 21 stages · 4 countries · Monaco to Granada, finishing on a climb to the Alhambra.",
    es: "Elige un ganador para cada etapa, demuestra a tus amigos que sabes más de ciclismo, y gana material de ciclismo. 3.298 km · 21 etapas · 4 países · de Mónaco a Granada, con final en alto en la Alhambra.",
  },
  ...
  "home.wrapBody": { en: "All 21 stages are done. Thanks for playing!", es: "Las 21 etapas han terminado. ¡Gracias por jugar!" },
  "home.jerseyBannerLock": { en: "Lock in your jersey predictions before Stage 5!", es: "¡Asegura tus pronósticos de maillots antes de la Etapa 5!" },
  ...
  "home.tourProgress": { en: "Race progress", es: "Progreso de la carrera" },
