...
export const RIDERS = [
  ...
  { id: "dmartinez", birthYear: 1996, name: "Daniel Martinez", team: "Red Bull - BORA Hansgrohe", confirmed: true, pcsSlug: "daniel-martinez", scores: { mountains: 65, hills: 40, itt: 35, ttt: 45, flat: 2 } },
  { id: "meeus", birthYear: 1999, name: "Jordi Meeus", team: "Red Bull - BORA Hansgrohe", confirmed: true, pcsSlug: "jordi-meeus", scores: { mountains: 1, hills: 20, itt: 10, ttt: 45, flat: 75 } },
  { id: "vanpoppel", birthYear: 1992, name: "Danny van Poppel", team: "Red Bull - BORA Hansgrohe", confirmed: true, pcsSlug: "danny-van-poppel", scores: { mountains: 1, hills: 15, itt: 10, ttt: 40, flat: 65 } },
  { id: "bilbao", birthYear: 1990, name: "Pello Bilbao", team: "Bahrain Victorious", confirmed: true, pcsSlug: "pello-bilbao", scores: { mountains: 35, hills: 35, itt: 25, ttt: 40, flat: 2 } },
  ...
  { id: "kron", birthYear: 1998, name: "Andreas Kron", team: "Uno-X Mobility", confirmed: true, pcsSlug: "andreas-kron", scores: { mountains: 10, hills: 35, itt: 15, ttt: 35, flat: 20 } },
  ...
  { id: "boivin", birthYear: 1989, name: "Guillaume Boivin", team: "NSN Cycling Team", confirmed: true, pcsSlug: "guillaume-boivin", scores: { mountains: 2, hills: 20, itt: 10, ttt: 30, flat: 35 } },
  ...
  { id: "balderstone", birthYear: 2001, name: "Abel Balderstone", team: "Caja Rural Seguros RGA", confirmed: true, pcsSlug: "abel-balderstone", scores: { mountains: 10, hills: 20, itt: 12, ttt: 25, flat: 10 } },
  { id: "fbarcelo", birthYear: 1996, name: "Fernando Barcelo", team: "Caja Rural Seguros RGA", confirmed: true, pcsSlug: "fernando-barcelo", scores: { mountains: 10, hills: 18, itt: 10, ttt: 25, flat: 10 } },
  { id: "berwick", birthYear: 1999, name: "Sebastian Berwick", team: "Caja Rural Seguros RGA", confirmed: true, pcsSlug: "sebastian-berwick", scores: { mountains: 2, hills: 15, itt: 10, ttt: 25, flat: 25 } },
  { id: "castellon", birthYear: 2000, name: "Jan Castellon", team: "Caja Rural Seguros RGA", confirmed: true, pcsSlug: "jan-castellon", scores: { mountains: 8, hills: 15, itt: 10, ttt: 25, flat: 10 } },
  { id: "gaviria", birthYear: 1994, name: "Fernando Gaviria", team: "Caja Rural Seguros RGA", confirmed: true, pcsSlug: "fernando-gaviria", scores: { mountains: 1, hills: 15, itt: 10, ttt: 35, flat: 55 } },
  ...
  { id: "oldani", birthYear: 1998, name: "Stefano Oldani", team: "Caja Rural Seguros RGA", confirmed: true, pcsSlug: "stefano-oldani", scores: { mountains: 2, hills: 20, itt: 10, ttt: 30, flat: 30 } },
  { id: "otruba", birthYear: 2000, name: "Jakub Otruba", team: "Caja Rural Seguros RGA", confirmed: true, pcsSlug: "jakub-otruba", scores: { mountains: 8, hills: 15, itt: 12, ttt: 25, flat: 10 } },
  { id: "jfparra", birthYear: 2001, name: "Jose Felix Parra", team: "Caja Rural Seguros RGA", confirmed: true, pcsSlug: "jose-felix-parra", scores: { mountains: 20, hills: 15, itt: 10, ttt: 25, flat: 5 } },
  ...
  { id: "grossschartner", birthYear: 1995, name: "Felix Grossschartner", team: "UAE Team Emirates XRG", confirmed: true, pcsSlug: "felix-grossschartner", scores: { mountains: 35, hills: 30, itt: 35, ttt: 50, flat: 2 } },
  ...
  { id: "scarr", birthYear: 1999, name: "Simon Carr", team: "Cofidis", confirmed: true, pcsSlug: "simon-carr", scores: { mountains: 25, hills: 25, itt: 15, ttt: 30, flat: 5 } },
