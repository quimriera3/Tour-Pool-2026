...
export function riderSpecialty(rider) {
  ...
  if (!entries.length) return "All-rounder";
...
const COUNTRY_CODES = {
  Algeria: "DZ", Australia: "AU", Austria: "AT", Belgium: "BE", Belize: "BZ", Bermuda: "BM",
  Brazil: "BR", Bulgaria: "BG", Canada: "CA", "Cayman Islands": "KY", Chile: "CL", China: "CN",
  Colombia: "CO", Comoros: "KM", "Costa Rica": "CR", Cyprus: "CY", "Czech Republic": "CZ",
  Denmark: "DK", Dominica: "DM", Ecuador: "EC", Eritrea: "ER", Estonia: "EE", Finland: "FI",
  France: "FR", Germany: "DE", "Great Britain": "GB", Greece: "GR", Guatemala: "GT",
  "Guinea-Bissau": "GW", Honduras: "HN", Hungary: "HU", Indonesia: "ID", Ireland: "IE", Israel: "IL",
  Italy: "IT", Japan: "JP", Jordan: "JO", Kazakhstan: "KZ", Kenya: "KE", Latvia: "LV",
  Luxembourg: "LU", Mauritius: "MU", Mexico: "MX", Monaco: "MC", Mongolia: "MN", Namibia: "NA",
  Netherlands: "NL", "New Zealand": "NZ", Norway: "NO", Panama: "PA", Paraguay: "PY",
  Philippines: "PH", Poland: "PL", Portugal: "PT", Romania: "RO", Rwanda: "RW",
  "Saudi Arabia": "SA", Serbia: "RS", Slovakia: "SK", Slovenia: "SI", "South Africa": "ZA",
  Spain: "ES", Sweden: "SE", Switzerland: "CH", Thailand: "TH", "Trinidad and Tobago": "TT",
  Ukraine: "UA", "United States": "US", Uruguay: "UY", Uzbekistan: "UZ", Venezuela: "VE", Zimbabwe: "ZW",
};
...
export function pcsUrl(rider) {
  return rider?.pcsSlug ? "https://www.procyclingstats.com/rider/" + rider.pcsSlug : null;
}
