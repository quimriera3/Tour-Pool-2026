...
// All 23 teams have now confirmed their full Tour 2026 squad (July 2026).
...
// Jersey picks are open until 1 hour before Stage 5 starts -- giving
// everyone time to watch the opening mountain stages and still adjust
// their jersey predictions before the first real climbing showdown.
export function jerseyLockDate() {
  var stage5 = STAGES.find(function(s) { return s.n === 5; });
  var start = stageStartDate(stage5 || STAGES[0]);
