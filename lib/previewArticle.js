      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "The field is now taking shape through federation announcements. Italy brings Elisa Longo Borghini and Silvia Persico, France has climbers and punchers including Evita Muzic and Cédrine Kerbaol, Spain has Mavi García and Paula Blasi, while the United States includes Kristen Faulkner. Depth matters enormously on a circuit where positioning before every climb is part of the race.",
            "The startlist is still provisional, so the pool treats the road race and time trial separately and only makes a rider selectable when there is a published basis to include her. That keeps the game useful without pretending a changing field is final days before the start.",
          ],
        },
        {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "El pelotón ya va tomando forma a través de los anuncios de las federaciones. Italia cuenta con Elisa Longo Borghini y Silvia Persico, Francia con escaladoras y puncheurs como Evita Muzic y Cédrine Kerbaol, España con Mavi García y Paula Blasi, y Estados Unidos incluye a Kristen Faulkner. La profundidad pesa muchísimo en un circuito donde colocarse antes de cada subida forma parte de la carrera.",
            "La startlist sigue siendo provisional, por eso la porra trata la ruta y la contrarreloj por separado y solo permite elegir a una corredora cuando existe una base publicada para incluirla. Así el juego puede abrir sin fingir que una lista que todavía cambia a pocos días de la salida es definitiva.",
          ],
        },
        {
    ...
    en: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            "**Remco Evenepoel** (Belgium) is the closest thing to a favourite. World champion in 2022, he has the engine for a 273 km race and Belgium has another winning card beside him, which makes every late move harder to read.",
            "**Mathieu van der Poel** (Netherlands) won the rainbow jersey in Glasgow in 2023. If the race comes down to a small group after twelve hard laps, nobody wants to bring his sprint to Avenue du Parc.",
            "**Wout van Aert** (Belgium) gives Belgium the opposite tactical option to Evenepoel: he can survive an attritional race and is one of the fastest finishers among the contenders if a group stays together.",
            "**Primoz Roglic** (Slovenia) leads Slovenia after Tadej Pogacar's injury ended his season. The course asks more explosiveness than a Grand Tour summit finish, but Roglic's reduced-group finish and experience make him dangerous.",
            "**Juan Ayuso** (Spain) has the climbing power for repeated Mount Royal laps and enough acceleration to matter in a selective finale. He is one of the most natural stage-race riders for this one-day profile.",
            "**Paul Seixas** (France) is taking on both elite events. A World Championship this long is a huge ask at his age, but his climbing level and recent form make him impossible to dismiss on a circuit that rewards repeated high-power efforts.",
            "**Richard Carapaz** (Ecuador) is the purest climber in this group. His best route to the jersey is to make the race harder and earlier than the faster finishers would like.",
            "**Tobias Halland Johannessen** (Norway) has the climbing level and durability to stay relevant deep into a race of attrition, particularly if the final laps become a sequence of attacks rather than one decisive sprint.",
            "**Jhonatan Narváez** (Ecuador) fits the circuit almost by definition: punchy uphill, tactically sharp and quick enough from a reduced group to punish hesitation.",
            "**Quinn Simmons** (United States) is the long-range wildcard. A hard six-hour race rewards riders willing to move before the obvious favourites, and that is exactly the type of race he can exploit.",
          ],
        },
        {
          ...
          paragraphs: [
            ...
            "Flat and long is the purest possible test of sustained power, which narrows the field sharply. **Remco Evenepoel** starts as the reference, with **Filippo Ganna** the obvious heavyweight rival and riders such as **Jakob Söderqvist**, **Paul Seixas** and **Bruno Armirail** adding depth to the provisional field. The ITT startlist is tracked separately from the road race because the two fields are not the same.",
          ],
        },
      ],
      closingPrefix: "Who takes the rainbow jersey in Montreal?",
    ...
    es: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            "**Remco Evenepoel** (Bélgica) es lo más parecido a un favorito. Campeón del mundo en 2022, tiene motor para 273 km y Bélgica dispone de otra carta ganadora a su lado, lo que vuelve mucho más difícil leer los movimientos finales.",
            "**Mathieu van der Poel** (Países Bajos) ganó el arcoíris en Glasgow en 2023. Si la carrera llega a un grupo reducido después de doce vueltas duras, nadie querrá llevar su esprint hasta la Avenue du Parc.",
            "**Wout van Aert** (Bélgica) ofrece la opción táctica opuesta a Evenepoel: puede sobrevivir a una carrera de desgaste y es uno de los rematadores más rápidos entre los candidatos si queda un grupo.",
            "**Primoz Roglic** (Eslovenia) lidera a su selección después de que la lesión de Tadej Pogacar pusiera fin a su temporada. El circuito exige más explosividad que un final de gran vuelta, pero su remate desde grupo reducido y su experiencia lo hacen peligroso.",
            "**Juan Ayuso** (España) tiene potencia de subida para repetir el Mont Royal y aceleración suficiente para jugarse un final selectivo. Es uno de los corredores de vueltas que mejor encajan en este perfil de un día.",
            "**Paul Seixas** (Francia) afronta las dos pruebas élite. Un Mundial tan largo es una exigencia enorme a su edad, pero su nivel escalando y su forma reciente lo hacen imposible de descartar en un circuito de esfuerzos repetidos a máxima potencia.",
            "**Richard Carapaz** (Ecuador) es el escalador más puro de este grupo. Su mejor camino hacia el arcoíris es endurecer la carrera antes de lo que querrían los corredores con mejor punta de velocidad.",
            "**Tobias Halland Johannessen** (Noruega) tiene el nivel de escalada y el fondo para seguir vivo muy tarde en una carrera de desgaste, sobre todo si las últimas vueltas se convierten en una cadena de ataques.",
            "**Jhonatan Narváez** (Ecuador) encaja casi por definición: explosivo en subida, tácticamente agudo y suficientemente rápido desde un grupo reducido para castigar cualquier duda.",
            "**Quinn Simmons** (Estados Unidos) es el comodín de larga distancia. Una carrera dura de seis horas premia a quien se atreve a moverse antes que los favoritos, y ese es exactamente el tipo de carrera que puede aprovechar.",
          ],
        },
        {
          ...
          paragraphs: [
            ...
            "Llana y larga es la prueba más pura posible de potencia sostenida, lo que estrecha mucho el abanico. **Remco Evenepoel** parte como referencia, con **Filippo Ganna** como gran rival de peso y nombres como **Jakob Söderqvist**, **Paul Seixas** y **Bruno Armirail** dando profundidad a la lista provisional. La startlist de la crono se controla por separado de la ruta porque no son el mismo pelotón.",
          ],
        },
      ],
      closingPrefix: "¿Quién se lleva el arcoíris en Montreal?",
