...
export const PREVIEW_ARTICLES = {
  "worlds-2026-women": {
    en: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "Final selections are not yet published — federations name their squads in the days before the race — so a full favourites list has to wait. What the course already tells us is the profile it rewards: a puncher who climbs, comfortable on repeated short steep efforts, and still fast after four and a half hours.",
          ],
        },
        {
      ...
      closingSuffix: "and see how your call compares with everyone else's. National selections are confirmed in the days before each race.",
    },
    ...
    es: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "Las listas definitivas todavía no están publicadas —las federaciones nombran a sus seleccionadas en los días previos—, así que una lista completa de favoritas tendrá que esperar. Lo que el recorrido ya nos dice es el perfil que premia: una puncheur que suba bien, cómoda en esfuerzos cortos y empinados repetidos, y todavía rápida después de cuatro horas y media.",
          ],
        },
        {
      ...
      closingSuffix: "y comprueba cómo se compara con la del resto. Las selecciones nacionales se confirman en los días previos a cada prueba.",
    },
  },
  ...
  "worlds-2026": {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "History supports this reading. The Montreal circuit has repeatedly produced winners in this mould at the Grand Prix, and the 1974 Worlds on much the same roads went to Merckx. Length is the hidden variable: at 273.4 km this is one of the longest road races on the calendar, and attrition matters as much as explosiveness.",
          ],
        },
        {
        ...
        },
        {
          ...
          paragraphs: [
            "The championships open on 20 September with a 39.2 km individual time trial, long by modern standards and almost dead flat at around 195 metres of elevation. It runs along the Saint Lawrence River, crosses the Samuel De Champlain Bridge, loops the Circuit Gilles Villeneuve — the Formula 1 track on Ile Notre-Dame — and returns over the Concorde Bridge to the same Avenue du Parc finish.",
    ...
    es: {
      ...
      metaDescription:
        "Previa completa del Mundial de Ciclismo en Ruta 2026 en Montreal: los 273,4 km del recorrido, el circuito del Mont Royal a doce vueltas, y análisis de los diez corredores que pueden ganar el maillot arcoíris.",
      eyebrow: "Previa del Mundial",
      h1: "Mundial de Ciclismo 2026: Previa del Recorrido y los Diez Corredores que Pueden Ganar",
      intro:
        "El maillot arcoíris vuelve a Montreal por primera vez desde 1974, cuando Eddy Merckx ganó el último Mundial disputado aquí. La prueba en ruta élite masculina de 2026 es descomunal: 273,4 kilómetros y 3.803 metros de desnivel, con final tras doce vueltas al circuito del Mont Royal. Y por primera vez en tres años no hay un favorito claro, porque el bicampeón defensor Tadej Pogacar está ausente por lesión. Es el Mundial más abierto en años: esto es lo que exige el recorrido, y quién puede responder.",
      sections: [
        {
        ...
        },
        {
          ...
          paragraphs: [
            "El Mundial arranca el 20 de septiembre con una contrarreloj individual de 39,2 km, larga para los estándares actuales y prácticamente llana, con unos 195 metros de desnivel. Bordea el río San Lorenzo, cruza el puente Samuel De Champlain, da la vuelta al Circuito Gilles Villeneuve (el trazado de Fórmula 1 de la isla de Notre-Dame) y regresa por el puente de la Concorde hasta la misma meta de la Avenue du Parc.",
