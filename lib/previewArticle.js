...
export const PREVIEW_ARTICLES = {
  ...
  en: {
    ...
    metaDescription:
      "La Vuelta 2026 preview: a 21-stage route from Monaco to Granada across four countries, with seven mountain stages, a gravel sector, a 32.5 km time trial and a summit finish at the Alhambra.",
    eyebrow: "Route preview",
    h1: "La Vuelta a España 2026 Route Preview: Monaco to Granada",
    intro:
      "The 81st edition of La Vuelta a España is one of the most unusual — and most demanding — in the race's history. For the first time it starts in Monaco, crosses France and Andorra before reaching Spanish soil, and ends not in Madrid but on a climb to the Alhambra in Granada. Across 21 stages and 3,291 kilometres the peloton faces seven mountain stages, a gravel sector, and two time trials. Here is what the route tells us about how this race will be won.",
    sections: [
      {
  ...
  ca: {
    ...
    intro:
      "La 81a edició de La Vuelta a Espanya és una de les més atípiques —i més exigents— de la seva història. Per primera vegada arrenca a Mònaco, travessa França i Andorra abans de trepitjar sòl espanyol, i no acaba a Madrid sinó en una pujada a l'Alhambra de Granada. En 21 etapes i 3.291 quilòmetres el pilot afronta set etapes de muntanya, un sector de grava i dues contrarellotges. Això és el que el recorregut ens diu sobre com es guanyarà aquesta cursa.",
    sections: [
      {
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "La segona i la tercera setmana són on es decideix la cursa. Calar Alto, a l'etapa 12, és una de les pujades més llargues d'Espanya i corona per damunt dels 2.100 m: una prova pura de potència sostinguda on no hi ha on amagar-se. L'etapa 14 acaba a la Sierra de la Pandera, històricament un dels finals més cruels de La Vuelta, estret i brutalment costerut. Després arriba la contrarellotge de 32,5 km entre El Puerto de Santa María i Jerez, la més llarga de La Vuelta en anys i la millor oportunitat perquè un rodador potent capgiri la classificació.",
        ],
      },
      {
  ...
  it: {
    ...
    intro:
      "L'81ª edizione della Vuelta di Spagna è una delle più atipiche — e più impegnative — della sua storia. Per la prima volta parte da Monaco, attraversa Francia e Andorra prima di toccare il suolo spagnolo, e non finisce a Madrid ma su una salita verso l'Alhambra di Granada. In 21 tappe e 3.291 chilometri il gruppo affronta sette tappe di montagna, un settore di sterrato e due cronometro. Ecco cosa ci dice il percorso su come si vincerà questa corsa.",
    sections: [
      {
  ...
  nl: {
    ...
    intro:
      "De 81e editie van de Ronde van Spanje is een van de meest bijzondere — en zwaarste — uit de geschiedenis van de koers. Voor het eerst start hij in Monaco, doorkruist Frankrijk en Andorra voordat Spaanse bodem wordt bereikt, en eindigt niet in Madrid maar op een klim naar het Alhambra in Granada. Over 21 etappes en 3.291 kilometer wachten het peloton zeven bergetappes, een gravelsector en twee tijdritten. Dit is wat het parcours zegt over hoe deze koers gewonnen wordt.",
    sections: [
      {
